...
OPS_DEF_COPP_CLASS(SFLOW_PACKET, "Sflow packets", OPS_COPP_QOS_QUEUE_SFLOW, 20000, 20000, ops_copp_sflow, ops_copp_egress_fp_sflow, OPS_COPP_INGRESS_FUNC_POINTERS())
